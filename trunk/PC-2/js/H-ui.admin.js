...
/*变量定义-by:lmn 2016.01.06*/
var PROJECT_STARTTIME="1970-01-01";//默认项目开始时间
var PROJECT_ENDTIME="2222-01-01";//默认项目结束时间
var URLHEAD="http://115.29.138.150:8090/jzy/public/jzyMas/";//获取url头部定义
/*获取顶部选项卡总长度*/
...
/*
	...
	h		弹出层高度（缺省调默认值）
*/
function layer_show(title,url,cValue,w,h){
	if (title == null || title == '') {
		title=false;
	};
	if (url == null || url == '') {
